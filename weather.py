...
def build_weather_query(city_input, imperial=False):
    ...
    Returns:
        str: URL formatted for a call to the API
    """
...
def display_weather_info(weather_data, imperial=False):
    ...
    Args:
        ...
        imperial (bool): Whether or not ot use imperial units
...
if __name__ == "__main__":
    user_argss = read_user_cli_args()
    query_url = build_weather_query(user_argss.city, user_argss.imperial)
    weather_data = get_weather_data(query_url)
    display_weather_info(weather_data, user_argss.imperial)
